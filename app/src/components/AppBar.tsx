      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-white text-neutral-content border-b border-zinc-600 bg-opacity-66">
        <div className="navbar-start align-items-center">
          <div className="hidden sm:inline w-22 h-22 md:p-2 ml-10">
            <Link href="https://solana.com" target="_blank" rel="noopener noreferrer" passHref className="text-black hover:text-white">
              <svg width="105%" height="24" viewBox="0 0 646 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1064_606)">
                  ...
                  <path d="M341.1 11H326.1V70.31C326.11 72.2539 326.505 74.1766 327.26 75.9678C328.015 77.7591 329.116 79.3836 330.5 80.7484C331.884 82.1132 333.525 83.1912 335.326 83.9208C337.128 84.6504 339.056 85.0171 341 85H386V70.2H341.1V11Z" fill="black" />
                </g>
                <defs>
                  ...
                  <clipPath id="clip0_1064_606">
                    <rect width="646" height="96" fill="black" />
                  </clipPath>
                </defs>
              </svg>
            </Link>
        ...
        <div>
          <h1 className='text-4xl text-green-500 font-extrabold'>SolFundMe</h1>
        </div>
        {/* Nav Links */}
        {/* Wallet & Settings */}
        <div className="navbar-end text-black">
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul tabIndex={0} className="p-2 shadow menu dropdown-content bg-base-100 rounded-box sm:w-52 text-white">
              <li>
